(()=>{
  ...
  #painel.sig-premium .sig-metric{position:relative;background:#fff;border:1px solid #e2e8f0;border-radius:18px;padding:18px 20px 16px;min-height:150px;box-shadow:0 8px 24px rgba(16,44,85,.055);overflow:hidden}
  ...
  #painel.sig-premium .sig-metric-icon{width:54px;height:54px;border-radius:16px;display:grid;place-items:center;font-size:25px;background:var(--soft,#edf5ff)}
  ...
  function montar(){
    ...
    p.innerHTML=`
      ...
      <div class="sig-metrics">
        <div class="sig-metric proc"><div class="sig-metric-top"><div class="sig-metric-icon">📁</div><div class="sig-metric-label">Processos ativos</div></div><div class="sig-metric-value" id="mproc">0</div><div class="sig-metric-note">Em andamento</div></div>
        <div class="sig-metric cli"><div class="sig-metric-top"><div class="sig-metric-icon">👥</div><div class="sig-metric-label">Clientes ativos</div></div><div class="sig-metric-value" id="mcli">0</div><div class="sig-metric-note">Carteira de clientes</div></div>
        <div class="sig-metric pra"><div class="sig-metric-top"><div class="sig-metric-icon">🗓</div><div class="sig-metric-label">Prazos pendentes</div></div><div class="sig-metric-value" id="mpra">0</div><div class="sig-metric-note">A vencer</div></div>
        <div class="sig-metric tar"><div class="sig-metric-top"><div class="sig-metric-icon">☑</div><div class="sig-metric-label">Tarefas pendentes</div></div><div class="sig-metric-value" id="mtar">0</div><div class="sig-metric-note">Suas atividades</div></div>
      </div>
    ...
    const b=document.getElementById('sigIrAgenda');if(b)b.onclick=()=>document.querySelector('#menu button[data-p="agenda"]')?.click();
  }
